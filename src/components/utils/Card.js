		...
		<div className={styles.container}>
			...
			<div className={styles.cardBody}>
				...
				<p className={styles.description}>
					With classic feathure such as the slim case,detail in rose gold and silver, and our heritage NATO
					strap in ruby red, classic Roselyn is an effortless day-to-evening timespace.
				</p>
